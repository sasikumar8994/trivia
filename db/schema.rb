...
ActiveRecord::Schema.define(version: 20170604173123) do
  ...
  create_table "submitted_answers", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["question_id"], name: "index_submitted_answers_on_question_id", using: :btree
    t.index ["user_id"], name: "index_submitted_answers_on_user_id", using: :btree
  end
